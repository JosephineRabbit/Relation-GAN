...
class Visualizer():
    ...
    def display_current_results(self, visuals, epoch, save_result,class_name = None):
        if self.display_id > 0:  # show images in the browser
            ...
            if ncols > 0:
                ...
                if class_name != None:
                    label_html_row = ''
                    label_html_row += '<td>label = %s</td>' % class_name[0]
                    label_html_row += '<td>pred = %s</td>' % class_name[1]
                    label_html_row += '<td>fake = %s</td>' % class_name[2]
                    label_html += '<tr>%s</tr>' % label_html_row
