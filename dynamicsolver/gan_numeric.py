...
def F(t, x):
    ...
    return [-p * theta1, -p * theta2, (1 - p) * varphi1*0.95**t, (1 - p) * varphi2*0.95**t]
...
anim.save('gan.gif', writer='imagemagick', dpi=80)
...
anim.save('wgan.gif', writer='imagemagick', dpi=80)
...
anim.save('wgangp1.gif', writer='imagemagick', dpi=80)
...
anim.save('wgangp0.gif', writer='imagemagick', dpi=80)
...
anim.save('ganqp.gif', writer='imagemagick', dpi=80)
